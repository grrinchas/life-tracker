module Svg.Path exposing
    ( Path, Subpath, subpath, emptySubpath, Instruction, Point
    , pathToString, pathToStringWithPrecision, pathToAttribute
    , StartingPoint, startAt, moveBy
    , CloseOption, closed, open
    , lineTo, lineBy, lineToMany, lineByMany
    , verticalTo, verticalBy, horizontalTo, horizontalBy
    , arcTo, arcBy
    , ArcFlag, largestArc, smallestArc
    , Direction, clockwise, antiClockwise
    , toStart
    , quadraticTo, quadraticBy, quadraticToMany, quadraticByMany
    , cubicTo, cubicBy, cubicToMany, cubicByMany
    , CurveContinuation
    , quadraticContinueTo, quadraticContinueBy, cubicContinueTo, cubicContinueBy
    -- curve
    -- types
    -- arc
    -- line
...
For an interactive visual demo, see <http://codepen.io/lingtalfi/pen/yaLWJG>.
